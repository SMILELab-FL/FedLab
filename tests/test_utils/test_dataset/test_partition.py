...
import os
import numpy as np
from fedlab.utils.dataset.partition import DataPartitioner, CIFAR10Partitioner, BasicPartitioner, VisionPartitioner
...
class BasicPartitionerTestCase(unittest.TestCase):
    ...
    def test_noniid_major_classes(self):
