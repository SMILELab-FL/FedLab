...
network_upper = DistNetwork(address=(args.ip_u, args.port_u), world_size=args.world_size_u, rank=args.rank_u, ethernet=args.ethernet_u)
network_lower = DistNetwork(address=(args.ip_l, args.port_l), world_size=args.world_size_l, rank=args.rank_l, ethernet=args.ethernet_l)
